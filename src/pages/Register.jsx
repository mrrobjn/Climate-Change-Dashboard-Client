  ...
  return (
    <div className={`container-register ${theme ? "dark" : "light"}`}>
      ...
      <div className="container-register-container">
        <div className="container-register-container-left">
          <div className="container-register-container-left-logo-icon">
            <svg
        ...
        <div className="container-register-container-right">
          <div className="block-register">
            ...
            <div className="title-cf-password">Confirm Password</div>
            <div className="cf-password-bar">
              <input
                type="password"
                className="input-cf-password"
                placeholder="&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;&#8226;"
              ></input>
              
              <button className="cf-password-bar-eyeIcon">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
                  viewBox="0 0 576 512"
            ...
            <div className="button-register">
              <button className="button-register-your-account">
                Create Account
              </button>
            </div>
            ...
            <div className="have-an-account">
              <div className="title-an-account">Already have an account?</div>
